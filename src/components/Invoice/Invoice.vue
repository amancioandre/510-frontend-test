<template>
  <v-content>
    <div style="max-width: 784px; max-height: 550px;">
      <v-card
        min-width="784"
        max-width="784"
        min-height="500"
        flat
        class="invoice-padding invoice-features"
      >
